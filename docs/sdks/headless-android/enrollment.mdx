...
For a smooth integration experience, we recommend using the [Android Seamless SDK](/docs/sdks/full-checkout/android-payments). This option provides a flexible enrollment solution with pre-built UI components and customization options.
</Tip>
